    ...
    <main className="app-shell">
          ...
          {view === 'table' ? (
            <section className="panel">
              <div className="panel-bar filter-bar">
                {/* Filterbereich mit Suchfeld und Status-/Prioritätsauswahl */}
              ...
              <div className="table-wrapper">
                {/* Tabelle mit Einträgen, Sortierung und Aktionen */}
                  ...
                  <thead>
                    <tr>
                      ...
                      <th>
                        ...
                        >
                          Name <span className="sort-indicator">
                            {sortConfig.key === 'name'
                      ...
                      <th>
                        ...
                        >
                          Status <span className="sort-indicator">
                      ...
                      <th>
                        ...
                        >
                          Priorität <span className="sort-indicator">
                      ...
                      <th>
                        ...
                        >
                          LastModified <span className="sort-indicator">
                        ...
                        <tr key={entry.id}>
                          ...
                          <td>
                            {editingId === entry.id ? (
                              ...
                              <span className={`priority-chip ${entry.priority}`}>
                          ...
                          <td className="action-cell">
                            {/* Aktionsbereich: Bearbeiten / Speichern / Löschen */}
                            {editingId === entry.id ? (
      ...
      {showCreateModal && (
        <div className="modal-backdrop" role="dialog" aria-modal="true">
          {/* Modal zum Erstellen eines neuen Eintrags */}
      ...
      {confirmDialog.visible && (
        <div className="modal-backdrop" role="dialog" aria-modal="true">
          {/* App-eigener Bestätigungsdialog für Löschaktionen */}
          <div className="modal-card">
            <h2>Bestätigung</h2>
